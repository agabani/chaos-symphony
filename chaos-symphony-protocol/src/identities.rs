...
/// Identities Event.
#[allow(clippy::module_name_repetitions)]
pub type IdentitiesEvent = Message<IdentitiesEventPayload>;

impl IdentitiesEvent {
    /// Endpoint.
    pub const ENDPOINT: &'static str = "/event/identities";

    /// Creates a new [`IdentitiesEvent`].
    #[must_use]
    pub fn new(id: Uuid, payload: IdentitiesEventPayload) -> Self {
        Self {
            id,
